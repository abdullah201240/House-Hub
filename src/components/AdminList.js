...
export default function AdminList() {
  ...
  const adminSignup = async () => {
    navigate('/adminSignup', { state: { data: state.data } });
  };
      ...
      <div className="container-fluid">
        <div className="row flex-nowrap">
          ...
          <div className="col py-3">
            ...
            <br />
            <h1 style={{ textAlign: "center" }}>All Admin list  <tb />  <tb />  <tb /> <a href='/adminSignup' onClick={adminSignup}><FaPlusCircle /></a></h1>
                ...
                {houseOwners.map((owner) => (
                  <tr key={owner.id}>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        <div className="ms-3">
                          <h4 className="fw-bold mb-1">{owner.address}</h4>
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <a href={`${API_BASE_URL}/${owner.photo}`} >
                        <img
                          src={`${API_BASE_URL}/${owner.photo}`}
                          alt=""
